...
public class DayCountWidgetProvider extends AppWidgetProvider {
  ...
  public void onDisabled(Context context) {
    ...
    PendingIntent pendingIntent =
        PendingIntent.getBroadcast(
            context, Times.ALARM_ID, alarmIntent, PendingIntent.FLAG_CANCEL_CURRENT);
  ...
  public void onDeleted(Context context, int[] appWidgetIds) {
    ...
    for (int appWidgetId : appWidgetIds) {
      db.delete(
          Widget.TABLE_NAME, Widget.WIDGET_ID + "=?", new String[] {String.valueOf(appWidgetId)});
    }
    db.close();
  }
  ...
  public static RemoteViews buildRemoteViews(Context context, int mAppWidgetId) {
    ...
    try {
      ...
      if (cursor.moveToFirst()) {
        ...
        // padding
        horizontalPadding = cursor.getInt(cursor.getColumnIndexOrThrow(Widget.HORIZONTAL_PADDING));
        verticalPadding = cursor.getInt(cursor.getColumnIndexOrThrow(Widget.VERTICAL_PADDING));
      } else {
    ...
    views.setTextViewText(
        R.id.widget_body, Dates.getWidgetContentSpannable(context, countBy, targetDay));
    ...
    views.setViewPadding(
        R.id.widget, horizontalPadding, verticalPadding, horizontalPadding, verticalPadding);
